...
//
//        try unsafeWrite(value.userDefaultsStorableValue, forKey: key)
//    }
//    
...
//        
//        try unsafeWrite(value.map(\.userDefaultsStorableValue), forKey: key)
//    }
//    
...
//
//        try unsafeWrite(value.mapValues(\.userDefaultsStorableValue), forKey: key)
//    }
//
